...
export function MFAEnroll({ onEnrolled, onCancel }: MFAEnrollProps) {
  ...
  return (
    <Card className="sift-card max-w-md w-full mx-auto p-6 space-y-5 shadow-lg border-border">
        ...
        <form onSubmit={handleVerify} className="space-y-3 pt-1">
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="000000"
              className="sift-input w-full text-center text-xl tracking-[0.3em] font-mono font-bold py-2 px-3 bg-surface"
            />
          </div>
