  ...
  activeSubs
    ...
    .forEach((sub) => {
      ...
      items.push({
        ...
        whyExplanation: `Marked as "Cancel Candidate" by you during your ledger value review.`,
        heuristicRule: 'Your declaration: Value Rating = "Cancel Candidate"',
        impactAmount: convertedMonthly,
        impactCurrency: targetCurrency,
  ...
  activeSubs
    ...
    .forEach((sub) => {
      ...
      items.push({
        ...
        whyExplanation: `Recorded billing history shows an increase of ${formatCurrency(sub.amount - sub.previous_amount!, sub.currency)}/${sub.billing_cycle}.`,
    ...
    .forEach((sub) => {
      ...
      if (daysUntil >= 0 && daysUntil <= 30) {
        ...
        items.push({
          ...
          heuristicRule: 'Renewal schedule: Yearly plan renewing within 30 days',
