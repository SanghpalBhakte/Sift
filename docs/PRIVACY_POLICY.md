...
- **Limitation**: If you track a subscription without prior statement history or previous price records, Sift cannot guess whether the merchant recently increased their pricing.

### C. Overlapping Service Clusters
